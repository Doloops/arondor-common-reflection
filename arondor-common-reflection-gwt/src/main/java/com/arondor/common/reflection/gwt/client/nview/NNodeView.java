...
public class NNodeView extends FlowPanel implements TreeNodePresenter.Display
{
    ...
    protected String getHelperText()
    {
        return helperText;
    }
