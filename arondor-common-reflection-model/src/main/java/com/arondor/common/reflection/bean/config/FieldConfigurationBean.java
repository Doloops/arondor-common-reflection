...
public class FieldConfigurationBean implements com.arondor.common.reflection.model.config.FieldConfiguration
{
    /**
     * 
     */
    ...
    private List<FieldConfiguration> objectConfigurations;
